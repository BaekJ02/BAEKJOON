...
### 접근 방법
총 가격, 개수를 변수로 입력받고, 개수만큼 반복문을 진행하여 각각 물건의 가격, 개수를 입력받고 그 둘의 곱을 임시 변수에 저장하여   
총 가격과 비교한다.

### 풀이
for문을 통해 각각의 물건, 개수의 변수값으로 그 곱을 임시 변수에 계속 더하고   
반복문이 끝나면 총 가격과 임시 변수에 있는 값을 비교하여 출력한다.
